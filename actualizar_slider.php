...
<body style="background-color:rgb(224, 224, 212)">
    ...
    <main class="container" style="margin-top: 20px;">
        <div class="row g-4">
            <div class="col-md-12">
                <h1 class="h2 pb-2 mb-4 text-center text-dark border-bottom border-dark">Editar sección de imágenes</h1>
                <div class="col-md-12 d-flex justify-content-center bg-secondary py-4 rounded">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td><img width="100px" src="imgSlider/<?php echo $fila['imagen']?>" alt="..."></td>
                            <td>
                                <a href="updateslider.php?id=<?php echo $fila['id']; ?>" class="btn btn-warning">Editar</a>
                                <form action="borrarslider.php" method="post">
